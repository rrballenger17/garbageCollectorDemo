...
public class Iload1BytecodeTest extends BytecodeTest {

  @Override
  @Before
  public void setUp() {
    super.setUp();
    frame.setLocalVariable(1, 42);
  }
  ...
  protected byte[] getBytes() {
    return new byte[] { (byte) Constants.ILOAD_1 };
  }
  ...
  public void testLocals() {
    interpreter.interpretBytecode(frame);
    assertEquals(42, frame.getLocalVariable(1));
  }
