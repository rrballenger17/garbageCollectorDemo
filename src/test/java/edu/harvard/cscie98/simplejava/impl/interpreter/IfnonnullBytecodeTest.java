...
public class IfnonnullBytecodeTest extends BytecodeTest {

  @Override
  @Before
  public void setUp() {
    super.setUp();
    frame.push(getRef(getObjectDescriptor(TypeFactory.fromBinaryName("java.lang.Object"))));
  }
  ...
  protected byte[] getBytes() {
    return new byte[] { (byte) Constants.IFNONNULL, 0, 42 };
  }
